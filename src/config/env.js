...
export const env = {
  ...
  smtp: {
    host: firstText(process.env.SMTP_HOST),
    port: Number(process.env.SMTP_PORT) || 587,
    user: firstText(process.env.SMTP_USER),
    pass: firstText(process.env.SMTP_PASS),
    from: firstText(process.env.SMTP_FROM) || 'LFE Platform <noreply@iub.edu.bd>',
  },
  resendApiKey: firstText(process.env.RESEND_API_KEY),
};
